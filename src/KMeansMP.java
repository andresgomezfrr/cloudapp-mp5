...
public final class KMeansMP {
    ...
    private static class ClusterExerciseB implements PairFunction<Tuple2<String, Vector>, Integer, String> {
        private KMeansModel model;
        public ClusterExerciseB(KMeansModel model) {
            this.model = model;
        }
    ...
    public static void main(String[] args) {
       if (args.length < 2) {
        ...
        results = titles.zip(points).mapToPair(new ClusterExerciseB(model)).groupByKey();
